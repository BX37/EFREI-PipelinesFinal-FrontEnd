pipeline {
    ...
    parameters {
        ...
        string(name: 'REGISTRY', defaultValue: 'registry.spokayhub.top', description: 'URL de mon registre Docker')
        string(name: 'GIT_URL', defaultValue: 'https://github.com/BX37/EFREI-PipelinesFinal-FrontEnd.git', description: 'URL de mon dépôt Git')
        ...
        string(name: 'VM_HOST', defaultValue: '172.179.237.62', description: 'Adresse IP ou hostname de la VM cible pour le déploiement')
